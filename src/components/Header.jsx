  ...
  return (
    <header style={{
      ...
      <div className="wrap hdr">
        <Link href="/" aria-label="Africode Studios home" className="hdr-logo">
          <Logo />
        </Link>
        ...
        <nav className="mainnav" aria-label="Main">
          {links.map((l) => {
            ...
            return (
              <Link key={l.to} href={l.to} className="navlink" style={{
        ...
        <div className="hdr-actions">
          ...
          <Link href="/start" className="btn btn-amber btn-sm hdr-cta">{t('nav.quote')}</Link>
        </div>
      </div>
